...
class BusinessRepositoryPort(Protocol):
    ...
    async def get_by_id_and_owner(self, business_id: UUID, owner_id: str) -> Business | None:
        ...
    ...
    async def replace_weekly_off_rules(self, business_id: UUID, new_rules: Sequence[WeeklyOffRule]) -> None:
        ...